...
$mail->Subject = 'Garderobsgenomgång - från kaos till personlig stil i nio steg';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
$mail->msgHTML(file_get_contents('garderoben.html'), dirname(__FILE__));
//Attach a file
...
if ($status) {
    ...
    //Set the subject line
    $mail2->Subject = 'Garderobsgenomgång - ny nedladdning';
    //Read an HTML message body from an external file, convert referenced images to embedded,
    //convert HTML into a basic plain-text alternative body
